...
public class FullScreenImageAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		Picasso.with(_activity).load(_imagePaths.get(position)).placeholder(R.drawable.place_holder_slider).fit().skipMemoryCache().error(R.drawable.place_holder_slider).into(imgDisplay);
